...
Detection: Check event triggered. Assigned event to self.
...
The logins from the rest of the accounts were all okay as well. It was determined that the alert was a TRUE BENIGN. Users and logged into only one country, there was no evidence of Impossible Travel. The users accounts were left intact due to expected behavior (not disabled).

### Containment, Eradication, and Recovery

Containment: There was no threat to contain.

Eradication: There was no threat to remove, further action may be taken pending a decision from management.
